...
export function TaskRecord({ stopTaskRecording }) {
  ...
  return (
    <>
      <div className="fixed left-0 top-0 w-full justify-center h-full z-50 flex-force bg-background items-center dragger">
        <div className="flex items-center justify-center w-full flex-1">
          <div>
            <StopCircleIcon
              onClick={stop}
              className="animate-pulse text-red-500 h-6 w-6 no-drag cursor-pointer hover:text-primary z-60"
            />
          </div>
